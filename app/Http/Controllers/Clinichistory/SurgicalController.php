...
class SurgicalController extends Controller
{
    ...
    public function index($id)
    {
        ...
        if ($is_records) {
            ...
            $data['o_derm'] = $o_derm;
            $o_hcp = Hcsurgical::where(['hc' => $o_derm->id, 'user' => $o->id])->orderBy('id', 'DESC')->first();
            $data['o_hcp'] = $o_hcp;
        }
        $data['t_records'] = $t;
    ...
    public function store(Request $request, $id)
    {
        ...
        $o_hcpro = Hcsurgical::create($aux_params);
        //HCTUMORS
    ...
    private function getpdfhc($id, $save = false)
    {
        ...
        // $data['o_hcpro'] = Hcsurgical::where(['hc' => $o_derm->id])->first();
