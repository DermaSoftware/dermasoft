...
class SubcategoriesController extends Controller
{
	private $tag_the = 'La';
    private $tag_o = 'a';
    private $r_name = 'admon/subcategories';
    private $v_name = 'admon.subcategories';
    private $c_name = 'Sub-Categoría';
    private $c_names = 'Sub-Categorías';
	private $list_tbl_fsc = ['name' => 'Nombre'];
	private $o_model = Subcategories::class;
