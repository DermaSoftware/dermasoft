...
class TplmailsController extends Controller
{
	private $tag_the = 'La';
    private $tag_o = 'a';
    private $r_name = 'admon/tplmails';
    private $v_name = 'admon.tplmails';
    private $c_name = 'Plantilla de correo';
    private $c_names = 'Plantillas de correo';
	private $list_tbl_fsc = ['name' => 'Nombre'];
	private $o_model = Tplmails::class;
