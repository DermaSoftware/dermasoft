...
class ServicesController extends Controller
{
	private $tag_the = 'El';
    private $tag_o = 'o';
    private $r_name = 'admon/services';
    private $v_name = 'admon.services';
    private $c_name = 'Servicio';
    private $c_names = 'Servicios';
	private $list_tbl_fsc = ['category' => 'Categoría','code' => 'Código','name' => 'Nombre','price' => 'Precio'];
	private $o_model = Services::class;
