...
class MedicinesController extends Controller
{
	private $tag_the = 'El';
    private $tag_o = 'o';
    private $r_name = 'admin/medicines';
    private $v_name = 'admin.medicines';
    private $c_name = 'Medicamento';
    private $c_names = 'Medicamentos';
	private $list_tbl_fsc = ['name' => 'Código','description' => 'Nombre'];
	private $o_model = Medicines::class;
	...
	public function fileImport(Request $request) {
        Excel::import(new MedicinesImport, $request->file('file')->store('temp'));
