...
class IndicationsController extends Controller
{
	private $tag_the = 'La';
    private $tag_o = 'a';
    private $r_name = 'admin/indications';
    private $v_name = 'admin.indications';
    private $c_name = 'Indicación';
    private $c_names = 'Indicaciones';
	private $list_tbl_fsc = ['description' => 'Descripción'];
	private $o_model = Indications::class;
