...
class ProceduresController extends Controller
{
	private $tag_the = 'El';
    private $tag_o = 'o';
    private $r_name = 'admin/procedures';
    private $v_name = 'admin.procedures';
    private $c_name = 'Procedimiento';
    private $c_names = 'Procedimientos';
	private $list_tbl_fsc = ['name' => 'Código','description' => 'Descripción'];
	private $o_model = Procedures::class;
	...
	public function fileImport(Request $request) {
        Excel::import(new ProceduresImport, $request->file('file')->store('temp'));
