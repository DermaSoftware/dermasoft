...
class PathologiesController extends Controller
{
	private $tag_the = 'La';
    private $tag_o = 'a';
    private $r_name = 'admin/pathologies';
    private $v_name = 'admin.pathologies';
    private $c_name = 'Patología';
    private $c_names = 'Patologías';
	private $list_tbl_fsc = ['name' => 'Código','description' => 'Descripción'];
	private $o_model = Pathologies::class;
	...
	public function fileImport(Request $request) {
        Excel::import(new PathologiesImport, $request->file('file')->store('temp'));
