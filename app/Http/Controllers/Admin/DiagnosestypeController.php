...
class DiagnosestypeController extends Controller
{
	private $tag_the = 'El';
    private $tag_o = 'o';
    private $r_name = 'admin/diagnosestype';
    private $v_name = 'admin.diagnosestype';
    private $c_name = 'Tipo de diagnóstico';
    private $c_names = 'Tipos de diagnósticos';
	private $list_tbl_fsc = ['name' => 'Nombre'];
	private $o_model = Diagnosestype::class;
