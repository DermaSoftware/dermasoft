...
class ChecklistsecurityController extends Controller
{
	private $tag_the = 'El';
    private $tag_o = 'o';
    private $r_name = 'admin/checklistsecurity';
    private $v_name = 'admin.checklistsecurity';
    private $c_name = 'Check list de seguridad';
    private $c_names = 'Checklists de seguridad';
	private $list_tbl_fsc = ['description' => 'Descripción'];
	private $o_model = Checklistsecurity::class;
