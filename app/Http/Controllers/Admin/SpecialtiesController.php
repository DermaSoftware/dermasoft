...
class SpecialtiesController extends Controller
{
	private $tag_the = 'La';
    private $tag_o = 'a';
    private $r_name = 'admin/specialties';
    private $v_name = 'admin.specialties';
    private $c_name = 'Especialidad';
    private $c_names = 'Especialidades';
	private $list_tbl_fsc = ['name' => 'Nombre','description' => 'Descripción'];
	private $o_model = Specialties::class;
