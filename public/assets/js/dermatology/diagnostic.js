$(function(){
    ...
    $('#diag_tab').on('click',function(){
        if($('#diagnostic_table').length > 0){
        ...
        var table = $('#diagnostic_table').DataTable({
            ...
            "columns": [{
                ...
                //     render: function(data, type, row) {
                //         let derm = derma_id;
                //         let url_update = `/clinichistory/diagnostics/${derm}/${row.id}/edit`;
        ...
        var tabla_tem = $("#diagnostic_table");
