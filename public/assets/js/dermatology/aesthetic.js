$(function () {
    ...
    $('#aest_tab').on('click', function () {

        if ($('#aesthetics_table').length > 0) {
        ...
        var table = $('#aesthetics_table').DataTable({
            ...
            "ajax": {
                "url": `/clinichistory/aesthetics/${derma_id}/${appointment}`,
                "type": 'GET',
            },
            "columns": [{
                "data": "id"
        ...
        var tabla_tem = $("#aesthetics_table");
        tabla_tem.on('click', "a[data-toggle='modal']", function (e) {
            ...
            $('#derma_modal div[class="modal-card"]').load(url, function () {
                ...
                $('#aesthetic_form').on('submit', function (event) {
                    ...
                    var $form = $(this);
                    url2 = $(this).attr('action')
                    var formData = new FormData(document.getElementById('aesthetic_form'))
                    $.ajax({
                        url: url2,
                        async: false,
