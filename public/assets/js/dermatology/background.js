$(function () {
    ...
    $('#antecedentes').on('click', function () {
        ...
        var table = $('#backgrouns').DataTable({
            ...
            //         let derm = derma_id;
            //         let url_update =
            //             `/clinichistory/backgrounds/${derm}/${row.id}/edit`;
        ...
        tabla_tem.on('click', "a[data-toggle='modal']", function (e) {
            ...
            $('#derma_modal div[class="modal-card"]').load(url, function () {
                ...
                $('#backgrouns_form').on('submit', function (event) {
                    ...
                    var $form = $(this);
                    url2 = $(this).attr('action')
                    var formData = new FormData(document.getElementById('backgrouns_form'))
                    $.ajax({
                        url: url2,
                        async: false,
