...
<body class="opened">
    ...
    <div id="huro-app" class="app-wrapper">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <div class="dropdown-content">
                                    ...
                                    <div class="dropdown-item is-button">
                                        <button onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="button h-button is-primary is-raised is-fullwidth logout-button">
        ...
        <div class="main-sidebar is-bordered">
            ...
            <div class="sidebar-inner">
                ...
                <ul class="bottom-menu">
                    ...
                    <li>
                        <a href="{{ Auth::user()->role == 1?url('admin/settings'):url('admon/settings') }}" id="open-settings" data-content="Settings">
                    ...
                    <li id="user-menu">
                        <div id="profile-menu" class="dropdown profile-dropdown dropdown-trigger is-spaced is-up">
                            <img src="{{ !empty(Auth::user()->photo)?Auth::user()->photo:'https://via.placeholder.com/150x150' }}" data-demo-src="{{ !empty(Auth::user()->photo)?Auth::user()->photo:'https://via.placeholder.com/150x150' }}" alt="">
        ...
        <!-- Content Wrapper -->
        <div class="view-wrapper is-pushed-full" data-naver-offset="150" data-menu-item="#home-sidebar-menu" data-mobile-item="#home-sidebar-menu-mobile">
                ...
                <div class="page-content is-relative">
                    <div class="page-title has-text-centered">
                        ...
                        <div class="toolbar ml-auto">
                            <div class="toolbar-link"><label class="dark-mode ml-auto"><input type="checkbox" checked><span></span></label></div>
		...
		if($('#calendar_doctor').length){
			...
			var calendar = new FullCalendar.Calendar(calendarEl, {
				...
				locale: 'es',
				selectable: true,<?= isset($str_days)?$str_days:'' ?><?= isset($locks_days)?$locks_days:'' ?>
				validRange: {
					start: '<?= date("Y-m-d") ?>'
				},
