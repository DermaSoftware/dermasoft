                        ...
                        <div class="dropdown-menu" role="menu">
                            <div class="dropdown-content">
                                <a href="<?= url($menu.'/'.$row->uuid.'/edit') ?>" class="dropdown-item is-media">
                                    ...
                                    <div class="meta">
                                        <span>Editar</span>
                                        <span>Modificar la capacitación</span>
                                    </div>
                                </a>
								<?php if($row->status == 'inactive'){ ?>
								<hr class="dropdown-divider">
                                <a href="<?= url($menu.'/pbr/'.$row->uuid) ?>" class="dropdown-item is-media">
                                    <div class="icon">
                                        <i class="lnil lnil-popup"></i>
                                    </div>
                                    <div class="meta">
                                        <span>Publicar</span>
                                        <span>Notificar y publicar capacitación</span>
                                    </div>
                                </a>
								<?php } ?>
								<hr class="dropdown-divider">
                                <a id="<?= $row->uuid ?>" href="javascript:void(0)" data-href="<?= url($menu.'/'.$row->uuid) ?>" data-itemtag="<?= $tag_the ?>" data-itemselect="<?= $tag_o ?>" data-nameitem="<?= $c_name ?>" class="dropdown-item is-media bg-danger text-fade-grey btn-delete-confirm-x">
                                    ...
                                    <div class="meta">
                                        <span>Eliminar</span>
                                        <span>Eliminar la capacitación</span>
                                    </div>
                                </a>
                            </div>
                        </div>
