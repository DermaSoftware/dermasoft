                        ...
                        <div class="columns is-multiline">
							...
							<div class="column is-12">
								<div class="buttons is-centered">
									<button type="button" class="button h-button h-modal-trigger" data-modal="capture_photographic_modal">
									 <span class="icon">
									  <i data-feather="eye"></i>
									 </span>
									 <span>Tomar foto</span>
									</button>
									<button type="button" class="button h-button is-primary h-modal-trigger" data-modal="upload_photographic_modal">
									 <span class="icon">
									  <i data-feather="edit-2"></i>
									 </span>
									 <span>Subir foto</span>
									</button>
									<a target="_blank" href="<?= url($menu.'/pdfrf/'.$o->uuid) ?>" class="button h-button is-success is-elevated">
										<span class="icon">
