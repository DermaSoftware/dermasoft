                        ...
                        <div class="dropdown-menu" role="menu">
                            <div class="dropdown-content">
								...
								<a href="<?= url($menu.'/'.$row->uuid) ?>" class="dropdown-item is-media">
                                    ...
                                    <div class="meta">
                                        <span>Detalles</span>
                                        <span>Ver <?= $tag_the ?> <?= $c_name ?></span>
                                    </div>
                                </a>
								<?php } else if($row->status != 'Finalizado'){ ?>
                                ...
                                <a id="<?= $row->uuid ?>" href="javascript:void(0)" data-href="<?= url($menu.'/'.$row->uuid) ?>" data-itemtag="<?= $tag_the ?>" data-itemselect="<?= $tag_o ?>" data-nameitem="<?= $c_name ?>" class="dropdown-item is-media bg-danger text-fade-grey btn-deletesupport-confirm-x">
                                    <div class="icon">
                                        <i class="lnil lnil-trash-can-alt"></i>
                                    </div>
                                    <div class="meta">
                                        <span>Finalizar</span>
                                        <span>Marcar como finalizado el ticket</span>
                                    </div>
                                </a>
								<?php } ?>
                            </div>
