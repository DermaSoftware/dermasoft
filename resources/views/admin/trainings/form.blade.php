...
<div class="column is-6">
	<div class="field box_hid_views">
		<div class="control">
			...
			<?php $n_att = 'Cuales?'; ?>
			<label><?= $n_att ?></label>
			<select name="<?= $t_att ?>[]" multiple data-url="<?= url('admin/hidviews') ?>" class="input select2_fsc sel_parent_views sel_parent_vis" data-xparent=".sel_hid_directed_to" data-option="Todos" data-box=".box_hid_views" style="width: 100%;" >
			</select>
		</div>
	</div>
</div>
