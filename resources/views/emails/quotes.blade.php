                    ...
                    <tbody>
                        <tr>
                            <td style="border-bottom:1px solid #f6f6f6;">
                                ...
                                <p style="margin-top:0px; color:#bbbbbb;font-size: 22px;">Se ha realizado una COTIZACIÓN DE PRODUCTOS Y/O SERVICIOS a su nombre, en este correo encontrarás un adjunto con el documento que se ha generado.</p>
                            </td>
                        </tr>
                        <tr>
