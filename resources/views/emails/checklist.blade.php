                    ...
                    <tbody>
                        <tr>
                            <td style="border-bottom:1px solid #f6f6f6;">
                                ...
                                <p style="margin-top:0px; color:#bbbbbb;font-size: 22px;">Queremos notificarte sobre el Check list seguridad, en este correo encontrarás un adjunto con el documento de CHECK LIST SEGURIDAD en nuestra plataforma.</p>
                            </td>
                        </tr>
                        <tr>
