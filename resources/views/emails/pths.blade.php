                    ...
                    <tbody>
                        <tr>
                            <td style="border-bottom:1px solid #f6f6f6;">
                                ...
                                <p style="margin-top:0px; color:#bbbbbb;font-size: 22px;">Queremos notificarte sobre la solicitud de solicitud de patologías, en este correo encontrarás un adjunto con el documento de SOLICITUD DE PATOLOGÍAS que se ha generado.</p>
                            </td>
                        </tr>
                        <tr>
