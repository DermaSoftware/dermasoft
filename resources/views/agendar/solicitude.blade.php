        ...
        <div class="columns">
            ...
            <div class="column is-12">
                ...
                <form action="<?= url('svsolicitude/' . $o_sol->uuid) ?>" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input name="action_type" type="hidden" value="qt_id" />
                    <div class="account-box is-form is-footerless">
                        <div class="form-head stuck-header">
                            <div class="form-head-inner">
                                <div class="left">
                                    <h3>Seleccionar sede y tipo de consulta:</h3>
                                    @if ($errors->any())
                                    ...
                                    <div class="column is-12">
                                        <div class="field">
                                            <div class="control">
                                                <?php $n_att = 'Sede'; ?>
                                                <label><?= $n_att ?></label>
                                                <select name="campus" class="input" required>
                                                    <option value="" selected disabled>--Seleccione--</option>
                                                    <?php foreach($o_all_sede as $key => $row){ ?>
