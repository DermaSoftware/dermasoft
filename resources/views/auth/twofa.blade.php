    ...
    <div class="columns is-gapless is-vcentered">
        ...
        <div class="column is-4 is-relative">
            ...
            <div class="is-form">
                <div class="hero-body">
                    <div class="form-text">
                        <h2>Factor doble autenticación</h2>
                        <p>Ya estas a un paso de ingresar, debes verificar el código suministrado al correo</p>
						@if ($errors->any())
                    ...
                    <form id="login-form" class="login-wrapper" method="POST" action="{{ url('twofactor') }}">
                        @csrf
						<div class="control has-validation">
                            <input name="code" type="text" class="input" placeholder="Código de verificación" required >
                        ...
                        <div class="button-wrap has-help">
                            <button type="submit" class="button h-button is-big is-rounded is-primary is-bold is-raised">Verificar</button>
						</div>
                    </form>
                </div>
            </div>
