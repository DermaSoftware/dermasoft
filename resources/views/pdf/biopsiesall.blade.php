...
<html lang="es">
  ...
  <body>
    <?php $strc_keys = ['other_procedure' => 'Cual?','disinfection' => 'Desinfección','antiseptic' => 'Cual antiséptico?','anesthesia' => 'Anestésia','type_anesthesia' => 'Tipo de anestésia','other_anesthesia' => 'Cual?','hemostasis' => 'Hemostasia','other_hemostasis' => 'Cual?','procedure_time' => 'Tiempo del procedimiento','complications' => 'Complicaciones','record_complications' => 'Registro de complicaciones presentadas','participants' => 'Datos de quienes participaron en el procedimiento','comments' => 'Comentarios adicionales','biopsy_method' => 'Método de biopsia','other_biopsy_method' => 'Cual?','biopsy_type' => 'Tipo de biopsia','required_margin' => 'Requirió margen','how_much' => 'Cuanto?','body_area' => 'Área','body_area_other' => 'Área corporal']; ?>
	...
	<?php $o_hcpro = $arow['o_hcpro']; ?>
	<?php $all_sut = $arow['all_sut']; ?>
	...
	<?php if(!empty($hrow->suture_type)){ ?><p><b>Tipo de sutura:</b> <?= $hrow->suture_type ?></p><?php } ?>
	<?php if(!empty($hrow->caliber)){ ?><p><b>Calibre:</b> <?= $hrow->caliber ?></p><?php } ?>
	<?php } ?>
	<?php } ?>
