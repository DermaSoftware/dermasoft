...
<html lang="es">
  ...
  <body>
    ...
    <h2 style="text-align: center;margin: 0;padding: 0;"><img src="<?= $logo ?>" alt="logo" style="display:inline;width: 100%;height: auto;max-width: 90px;float: left;" /><img src="<?= $photo ?>" class="img-thumbnail" alt="Foto" style="display:inline;width: 100%;height: auto;max-width: 90px;float: right;" /> <small><br>SOLICITUD DE PATOLOGÍAS</small></h2>
	...
	<h3 style="text-align: center;">Solicitud de patologías</h3>

	<h4 style="font-weight: normal;"><b><u>Fecha:</u></b> <?= $date_hc ?></h4>



	<h4 style="font-weight: bold;">Observaciones y/o anexos</h4>

	<p><?= $o_obj_item->annexes ?></p>
	<?php if(count($all_items) > 0){ ?>
	<br>
	<h4>Lista de patologías</h4>
	<table class="table table-striped">
        ...
        <tbody>
			...
			<tr>
				<td><?= $hrow->pivot->code ?></td>
				<td><?= $hrow->pivot->pathologie ?></td>
				<td><?= $hrow->pivot->note ?></td>
			</tr>
			<?php } ?>
		</tbody>
	</table>
