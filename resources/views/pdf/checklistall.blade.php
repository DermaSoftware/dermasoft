...
<html lang="es">
  ...
  <body>
    <h2 style="text-align: center;margin: 0;padding: 0;"><img src="<?= $logo ?>" alt="logo" style="display:inline;width: 100%;height: auto;max-width: 90px;float: left;" /><img src="<?= $photo ?>" class="img-thumbnail" alt="Foto" style="display:inline;width: 100%;height: auto;max-width: 90px;float: right;" /> <small><br>CHECK LIST SEGURIDAD</small></h2>
	...
	<h3 style="text-align: center;">Check list seguridad</h3>
	...
	<p style="font-weight: normal;"><b><u>Diligenciado por:</u></b> <?= $o_obj_item->getCreatedBy() ?></p>
	<?php } ?>
