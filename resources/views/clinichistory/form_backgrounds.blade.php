    ...
    <div class="column is-12">
        ...
        <div class="card">
            <header class="card-header">
                <p class="card-header-title">Antecedentes</p>
                <a id="add_anexo" href="<?= url($menu . '/backgrounds/' . $o_derm->id .'/'.$appointment. '/add') ?>"
                    data-toggle="modal" data-modal="derma_modal" class="h-modal-trigger btn btn card-header-icon">
                    <span class="fas fa-plus mr-2"></span>Adicionar
                </a>
            </header>
            <div class="card-content">
                <div class="content">
                    <table id="backgrouns" class="table is-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>UUID</th>
