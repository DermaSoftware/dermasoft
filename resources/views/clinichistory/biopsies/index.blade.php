...
<div class="account-wrapper">
    <div class="columns">
        <div class="column is-12">
            <form action="{{url($menu.'/biopsies/create/'.$o->uuid)}}" method="post" enctype="multipart/form-data">
			{{csrf_field()}}
                ...
                <div class="form-head stuck-header">
                    <div class="form-head-inner">
                        ...
                        <div class="right">
                            <div class="buttons">
                                <?php if($is_records){ ?>
								<a href="<?= url($menu.'/biopsies/list/'.$o->uuid) ?>" class="button h-button is-primary is-dark-outlined">
