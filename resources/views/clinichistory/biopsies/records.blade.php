            ...
            <div class="demo-title">
				<div class="form-head stuck-header">
					<div class="form-head-inner">
						<h3 class="title is-thin is-5">Historial de consultas <a target="_blank" href="<?= url($menu.'/biopsies/records/'.$o->uuid) ?>" class="button h-button is-primary is-rounded is-elevated" style="float: right;"><span class="icon"><i class="fas fa-download"></i></span> <span>Descargar historial</span></a></h3>
					</div>
				</div>
            </div>
        </div>
                    ...
                    <div class="dropdown is-spaced is-dots is-right dropdown-trigger is-pushed-mobile is-up">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <div class="dropdown-content">
                                <a target="_blank" href="<?= url($menu.'/biopsies/hcpdf/'.$row->uuid) ?>" class="dropdown-item is-media">
                                    <div class="icon">
