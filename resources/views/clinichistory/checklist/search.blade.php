...
<div class="account-wrapper">
    <div class="columns">
        <div class="column is-12">
            <form action="{{url($menu.'/'.$hc_view.'/search')}}" method="post" enctype="multipart/form-data">
			{{csrf_field()}}
        ...
        $(function() {
            ...
            $('.patine_sl').on('change',function(){
                ...
                var data = {
                    ...
                    "patient": value,
                    "only_types":[
                        'Biopsías y/o procedimientos', 'Procedimientos Estéticos', 'Descripción Quirúrgica','Crioterapia'
                    ]
                }
