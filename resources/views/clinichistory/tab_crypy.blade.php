    ...
    <div class="column is-12">
        ...
        <div class="card">
            <header class="card-header">
                ...
                <a id="add_cryppy" href="<?= url($menu . '/cryotherapies/' . $o_derm->id .'/'.$appointment. '/add') ?>"
            ...
            <div class="card-content">
                <div class="content">
                    <table id="crypy_table" class="table is-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>UUID</th>
                                <th>Diagnóstico</th>
                                <th>Tipo procedimeinto</th>
                                {{-- <th>Suturas</th> --}}
                                <th>Creado</th>
