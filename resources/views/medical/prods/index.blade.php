			...
			<div class="account-box is-form is-footerless">
                ...
                <div class="form-body">
					...
					<div class="columns is-multiline">
						...
						<div class="column is-12">
							<a href="javascript:void(0)" class="button h-button is-primary is-dark-outlined btn_add_prods">Agregar</a>
						</div>
						<div class="column is-12">
							<hr>
						</div>
						
						<div class="column is-12 inner_table_prods is-hidden">
							<div class="s-card" style="margin-top: 20px;max-height: 400px;overflow: auto;">
								...
								<table class="table is-hoverable is-fullwidth table_prods">
									<tbody>
										<tr>
											<th>Procedimiento</th>
											<th>Observaciones</th>
